...
#+name: note_name
#+begin_src scheme :var tbl=note_names[2:8] :results value
  <<log2_func>>
  <<octave_reduction>>
...
Give a ratio as string and returns the largest prime factor of the numerator and denominator by way of [[*working scheme factorization][working scheme factorization]].
...
|     5 | notename + alteration + oaa |          |
|     7 | notename + alteration + oba |          |
|    11 | notename + alteration + oca |          |
|    13 | notename + alteration + oda |          |
|    17 | notename + alteration + oea |          |
